...
plot(dt$obstime, dt$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
plot(dt$obstime, dt$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(dt$obstime, dt$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
